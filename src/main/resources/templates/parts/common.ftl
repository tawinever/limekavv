        ...
        <div class="main-menu">
            <div class="scroll">
                <ul class="list-unstyled">
                    ...
                    <li <#if __url == "/transfer"> class="active" </#if>>
                        <a href="/transfer">
                            <i class="iconsmind-Financial"></i>Withdraw
                        </a>
                    </li>
                </ul>
            </div>
...
<#macro admin>
    ...
    <div class="sidebar">
        <div class="main-menu">
            <div class="scroll">
                <ul class="list-unstyled">
                    <li <#if __url == "/stats"> class="active" </#if>>
                        <a href="/stats">
                            <i class="iconsmind-Dashboard"></i>Dashboard
                        </a>
                    </li>
                ...
                <div class="col-12 col-md-10 mx-auto my-auto">
                    <div class="card auth-card">
                        <div class="position-relative image-side ">
                            ...
                            <p class="white mb-0">
                                The state-of-the-art polling system.
                            </p>
                        </div>
                        <div class="form-side">
                            <a href="#dashboard">
                            ...
                            <h6 class="mb-4">Ooops... looks like an error occurred!</h6>
                            <p class="mb-0 text-muted text-small mb-0">Error code</p>
                            <p class="display-1 font-weight-bold mb-5">
                                <#nested>
                            </p>
                            <#if __user.getName() == "admin">
                                <a href="/stats" class="btn btn-primary btn-lg btn-shadow">GO BACK</a>
                            <#else >
                                <a href="/profile" class="btn btn-primary btn-lg btn-shadow">GO BACK</a>
                            </#if>
